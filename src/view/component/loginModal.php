<div id="modal login" class="hidden fixed top-0 bg-opacity-50 flex-col items-center justify-center w-screen h-screen bg-gray-900 text-gray-700">
	...
	<form class="flex flex-col bg-white rounded shadow-lg p-12 mt-12" action="" method="post">
		...
		<button type="submit" class="flex items-center justify-center h-12 px-6 w-64 bg-eagleGreen mt-8 rounded font-semibold text-sm text-mintCream hover:text-vividSky" onclick="cross()" required name="button" type="submit" value="login">Ce connecter</button>
