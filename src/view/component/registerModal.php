<div id="modal register" class="hidden fixed top-0 bg-opacity-50 flex-col items-center justify-center w-screen h-screen bg-gray-900 text-gray-700">
	...
	<form class="flex flex-col bg-white shadow-lg p-12 mt-12" action="" method="post">
		...
		<input class="flex items-center h-12 px-4 w-64 bg-gray-200 mt-2 focus:outline-none focus:ring-2" required autocomplete="given-name" name="firstname" type="text">
		<label class="font-semibold text-xs" for="lastname">Nom</label>
		<input class="flex items-center h-12 px-4 w-64 bg-gray-200 mt-2 focus:outline-none focus:ring-2" required autocomplete="family-name" name="lastname" type="text">
		...
		<input class="flex items-center h-12 px-4 w-64 bg-gray-200 mt-2 focus:outline-none focus:ring-2" required autocomplete="bday" name="birthDate" type="date">
		...
		<input class="flex items-center h-12 px-4 w-64 bg-gray-200 mt-2 focus:outline-none focus:ring-2" required autocomplete="street-address" name="adress" type="text">
		<button class="flex items-center justify-center h-12 px-6 w-64 bg-blue-600 mt-8 rounded font-semibold text-sm text-blue-100 hover:bg-blue-700" required name="button" type="submit" value="register">Ce connecter</button>
	</form>
